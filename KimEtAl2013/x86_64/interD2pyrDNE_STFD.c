...
#define nrn_init _nrn_init__interD2pyrDNE_STFD
#define _nrn_initial _nrn_initial__interD2pyrDNE_STFD
#define nrn_cur _nrn_cur__interD2pyrDNE_STFD
#define _nrn_current _nrn_current__interD2pyrDNE_STFD
#define nrn_jacob _nrn_jacob__interD2pyrDNE_STFD
#define nrn_state _nrn_state__interD2pyrDNE_STFD
#define _net_receive _net_receive__interD2pyrDNE_STFD 
#define release release__interD2pyrDNE_STFD 
...
#define GAP1 GAP1_interD2pyrDNE_STFD
#define NE2 NE2_interD2pyrDNE_STFD
#define NEn NEn_interD2pyrDNE_STFD
#define eta eta_interD2pyrDNE_STFD
#define omega omega_interD2pyrDNE_STFD
#define unirand unirand_interD2pyrDNE_STFD
...
#define Beta2 Beta2_interD2pyrDNE_STFD
 double Beta2 = 0.0001;
#define Beta1 Beta1_interD2pyrDNE_STFD
 double Beta1 = 0.001;
#define GAPstop1 GAPstop1_interD2pyrDNE_STFD
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_interD2pyrDNE_STFD
 double GAPstart1 = 96000;
#define NE_S NE_S_interD2pyrDNE_STFD
 double NE_S = 1;
#define NE_t2 NE_t2_interD2pyrDNE_STFD
 double NE_t2 = 1;
#define NE_t1 NE_t1_interD2pyrDNE_STFD
 double NE_t1 = 1;
#define NEstop2 NEstop2_interD2pyrDNE_STFD
 double NEstop2 = 36000;
#define NEstart2 NEstart2_interD2pyrDNE_STFD
 double NEstart2 = 35900;
#define NEstop1 NEstop1_interD2pyrDNE_STFD
 double NEstop1 = 40000;
#define NEstart1 NEstart1_interD2pyrDNE_STFD
 double NEstart1 = 39500;
#define k k_interD2pyrDNE_STFD
 double k = 0.01;
 ...
 "Beta1_interD2pyrDNE_STFD", "/ms",
 "Beta2_interD2pyrDNE_STFD", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_gaba", "ms",
 "AlphaTmax_gaba", "/ms",
 ...
 "k_interD2pyrDNE_STFD", &k_interD2pyrDNE_STFD,
 "GAPstart1_interD2pyrDNE_STFD", &GAPstart1_interD2pyrDNE_STFD,
 "GAPstop1_interD2pyrDNE_STFD", &GAPstop1_interD2pyrDNE_STFD,
 "NEstart1_interD2pyrDNE_STFD", &NEstart1_interD2pyrDNE_STFD,
 "NEstop1_interD2pyrDNE_STFD", &NEstop1_interD2pyrDNE_STFD,
 "NEstart2_interD2pyrDNE_STFD", &NEstart2_interD2pyrDNE_STFD,
 "NEstop2_interD2pyrDNE_STFD", &NEstop2_interD2pyrDNE_STFD,
 "NE_t1_interD2pyrDNE_STFD", &NE_t1_interD2pyrDNE_STFD,
 "NE_t2_interD2pyrDNE_STFD", &NE_t2_interD2pyrDNE_STFD,
 "NE_S_interD2pyrDNE_STFD", &NE_S_interD2pyrDNE_STFD,
 "Beta1_interD2pyrDNE_STFD", &Beta1_interD2pyrDNE_STFD,
 "Beta2_interD2pyrDNE_STFD", &Beta2_interD2pyrDNE_STFD,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 interD2pyrDNE_STFD /home/nest/Desktop/Project_codes/KimEtAl2013/x86_64/interD2pyrDNE_STFD.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 146 in file interD2pyrDNE_STFD.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nest/Desktop/Project_codes/KimEtAl2013/mods/interD2pyrDNE_STFD.mod";
static const char* nmodl_file_text = 
  ":Interneuron Cells to Pyramidal Cells GABA with local Ca2+ pool and read public soma Ca2+ pool\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS interD2pyrDNE_STFD\n"
  ...
  "\n"
  "\n"
  "	g_gaba = gbar_gaba*r_gaba*facfactor*NEn(NEstart1,NEstop1)*NE2(NEstart2,NEstop2)    : Dopamine & Norepinephrine effect on GABA		    \n"
  "	igaba = W*g_gaba*(v - Erev_gaba)\n"
  "\n"
  "	ICag = P0g*g_gaba*(v - eca)	\n"
