...
#define nrn_init _nrn_init__tone2pyrVNE_LAdd
#define _nrn_initial _nrn_initial__tone2pyrVNE_LAdd
#define nrn_cur _nrn_cur__tone2pyrVNE_LAdd
#define _nrn_current _nrn_current__tone2pyrVNE_LAdd
#define nrn_jacob _nrn_jacob__tone2pyrVNE_LAdd
#define nrn_state _nrn_state__tone2pyrVNE_LAdd
#define _net_receive _net_receive__tone2pyrVNE_LAdd 
#define release release__tone2pyrVNE_LAdd 
...
#define NE2 NE2_tone2pyrVNE_LAdd
#define NEn NEn_tone2pyrVNE_LAdd
#define eta eta_tone2pyrVNE_LAdd
#define omega omega_tone2pyrVNE_LAdd
#define sfunc sfunc_tone2pyrVNE_LAdd
...
#define Beta2 Beta2_tone2pyrVNE_LAdd
 double Beta2 = 0.0001;
#define Beta1 Beta1_tone2pyrVNE_LAdd
 double Beta1 = 0.001;
#define NE_S NE_S_tone2pyrVNE_LAdd
 double NE_S = 1.5;
#define NE_t2 NE_t2_tone2pyrVNE_LAdd
 double NE_t2 = 0.9;
#define NE_t1 NE_t1_tone2pyrVNE_LAdd
 double NE_t1 = 1;
#define NEstop2 NEstop2_tone2pyrVNE_LAdd
 double NEstop2 = 36000;
#define NEstart2 NEstart2_tone2pyrVNE_LAdd
 double NEstart2 = 35900;
#define NEstop1 NEstop1_tone2pyrVNE_LAdd
 double NEstop1 = 40000;
#define NEstart1 NEstart1_tone2pyrVNE_LAdd
 ...
 "Beta1_tone2pyrVNE_LAdd", "/ms",
 "Beta2_tone2pyrVNE_LAdd", "/ms",
 "Cdur_nmda", "ms",
 "AlphaTmax_nmda", "/ms",
 "Beta_nmda", "/ms",
 "Erev_nmda", "mV",
 ...
 "NEstart1_tone2pyrVNE_LAdd", &NEstart1_tone2pyrVNE_LAdd,
 "NEstop1_tone2pyrVNE_LAdd", &NEstop1_tone2pyrVNE_LAdd,
 "NEstart2_tone2pyrVNE_LAdd", &NEstart2_tone2pyrVNE_LAdd,
 "NEstop2_tone2pyrVNE_LAdd", &NEstop2_tone2pyrVNE_LAdd,
 "NE_t1_tone2pyrVNE_LAdd", &NE_t1_tone2pyrVNE_LAdd,
 "NE_t2_tone2pyrVNE_LAdd", &NE_t2_tone2pyrVNE_LAdd,
 "NE_S_tone2pyrVNE_LAdd", &NE_S_tone2pyrVNE_LAdd,
 "Beta1_tone2pyrVNE_LAdd", &Beta1_tone2pyrVNE_LAdd,
 "Beta2_tone2pyrVNE_LAdd", &Beta2_tone2pyrVNE_LAdd,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 tone2pyrVNE_LAdd /home/nest/Desktop/Project_codes/KimEtAl2013/x86_64/tone2pyrVNE_LAdd.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nest/Desktop/Project_codes/KimEtAl2013/mods/tone2pyrVNE_LAdd.mod";
static const char* nmodl_file_text = 
  ":Tone to Pyramidal Cells AMPA+NMDA with local Ca2+ pool\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS tone2pyrVNE_LAdd\n"
  "	USEION ca READ eca	\n"
