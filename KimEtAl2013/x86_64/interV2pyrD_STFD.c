...
#define nrn_init _nrn_init__interV2pyrD_STFD
#define _nrn_initial _nrn_initial__interV2pyrD_STFD
#define nrn_cur _nrn_cur__interV2pyrD_STFD
#define _nrn_current _nrn_current__interV2pyrD_STFD
#define nrn_jacob _nrn_jacob__interV2pyrD_STFD
#define nrn_state _nrn_state__interV2pyrD_STFD
#define _net_receive _net_receive__interV2pyrD_STFD 
#define release release__interV2pyrD_STFD 
...
#define GAP1 GAP1_interV2pyrD_STFD
#define eta eta_interV2pyrD_STFD
#define omega omega_interV2pyrD_STFD
#define unirand unirand_interV2pyrD_STFD
...
#define GAPstop1 GAPstop1_interV2pyrD_STFD
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_interV2pyrD_STFD
 double GAPstart1 = 96000;
#define k k_interV2pyrD_STFD
 double k = 0.01;
 ...
 "k_interV2pyrD_STFD", &k_interV2pyrD_STFD,
 "GAPstart1_interV2pyrD_STFD", &GAPstart1_interV2pyrD_STFD,
 "GAPstop1_interV2pyrD_STFD", &GAPstop1_interV2pyrD_STFD,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 interV2pyrD_STFD /home/nest/Desktop/Project_codes/KimEtAl2013/x86_64/interV2pyrD_STFD.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 136 in file interV2pyrD_STFD.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nest/Desktop/Project_codes/KimEtAl2013/mods/interV2pyrD_STFD.mod";
static const char* nmodl_file_text = 
