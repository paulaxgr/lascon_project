...
#define nrn_init _nrn_init__pyrD2pyrV_STFD
#define _nrn_initial _nrn_initial__pyrD2pyrV_STFD
#define nrn_cur _nrn_cur__pyrD2pyrV_STFD
#define _nrn_current _nrn_current__pyrD2pyrV_STFD
#define nrn_jacob _nrn_jacob__pyrD2pyrV_STFD
#define nrn_state _nrn_state__pyrD2pyrV_STFD
#define _net_receive _net_receive__pyrD2pyrV_STFD 
#define release release__pyrD2pyrV_STFD 
...
#define GAP1 GAP1_pyrD2pyrV_STFD
#define eta eta_pyrD2pyrV_STFD
#define omega omega_pyrD2pyrV_STFD
#define sfunc sfunc_pyrD2pyrV_STFD
#define unirand unirand_pyrD2pyrV_STFD
...
#define GAPstop1 GAPstop1_pyrD2pyrV_STFD
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_pyrD2pyrV_STFD
 ...
 "GAPstart1_pyrD2pyrV_STFD", &GAPstart1_pyrD2pyrV_STFD,
 "GAPstop1_pyrD2pyrV_STFD", &GAPstop1_pyrD2pyrV_STFD,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyrD2pyrV_STFD /home/nest/Desktop/Project_codes/KimEtAl2013/x86_64/pyrD2pyrV_STFD.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 145 in file pyrD2pyrV_STFD.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nest/Desktop/Project_codes/KimEtAl2013/mods/pyrD2pyrV_STFD.mod";
static const char* nmodl_file_text = 
  ":Pyramidal Cells to Pyramidal Cells AMPA+NMDA with local Ca2+ pool\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS pyrD2pyrV_STFD\n"
  "	USEION ca READ eca	\n"
