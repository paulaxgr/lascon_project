...
#define nrn_init _nrn_init__interD2pyrDDANE_STFD
#define _nrn_initial _nrn_initial__interD2pyrDDANE_STFD
#define nrn_cur _nrn_cur__interD2pyrDDANE_STFD
#define _nrn_current _nrn_current__interD2pyrDDANE_STFD
#define nrn_jacob _nrn_jacob__interD2pyrDDANE_STFD
#define nrn_state _nrn_state__interD2pyrDDANE_STFD
#define _net_receive _net_receive__interD2pyrDDANE_STFD 
#define release release__interD2pyrDDANE_STFD 
...
#define DA2 DA2_interD2pyrDDANE_STFD
#define DA1 DA1_interD2pyrDDANE_STFD
#define GAP1 GAP1_interD2pyrDDANE_STFD
#define NE2 NE2_interD2pyrDDANE_STFD
#define NEn NEn_interD2pyrDDANE_STFD
#define eta eta_interD2pyrDDANE_STFD
#define omega omega_interD2pyrDDANE_STFD
#define unirand unirand_interD2pyrDDANE_STFD
...
#define Betan2 Betan2_interD2pyrDDANE_STFD
 double Betan2 = 0.0001;
#define Betan1 Betan1_interD2pyrDDANE_STFD
 double Betan1 = 0.001;
#define Beta2 Beta2_interD2pyrDDANE_STFD
 double Beta2 = 0.0001;
#define Beta1 Beta1_interD2pyrDDANE_STFD
 double Beta1 = 0.001;
#define DA_S DA_S_interD2pyrDDANE_STFD
 double DA_S = 1.6;
#define DA_t2 DA_t2_interD2pyrDDANE_STFD
 double DA_t2 = 1.5;
#define DA_t1 DA_t1_interD2pyrDDANE_STFD
 double DA_t1 = 0.7;
#define DAstop2 DAstop2_interD2pyrDDANE_STFD
 double DAstop2 = 36000;
#define DAstart2 DAstart2_interD2pyrDDANE_STFD
 double DAstart2 = 35900;
#define DAstop1 DAstop1_interD2pyrDDANE_STFD
 double DAstop1 = 40000;
#define DAstart1 DAstart1_interD2pyrDDANE_STFD
 double DAstart1 = 39500;
#define GAPstop1 GAPstop1_interD2pyrDDANE_STFD
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_interD2pyrDDANE_STFD
 double GAPstart1 = 96000;
#define NE_S NE_S_interD2pyrDDANE_STFD
 double NE_S = 1;
#define NE_t2 NE_t2_interD2pyrDDANE_STFD
 double NE_t2 = 1;
#define NE_t1 NE_t1_interD2pyrDDANE_STFD
 double NE_t1 = 1;
#define NEstop2 NEstop2_interD2pyrDDANE_STFD
 double NEstop2 = 36000;
#define NEstart2 NEstart2_interD2pyrDDANE_STFD
 double NEstart2 = 35900;
#define NEstop1 NEstop1_interD2pyrDDANE_STFD
 double NEstop1 = 40000;
#define NEstart1 NEstart1_interD2pyrDDANE_STFD
 double NEstart1 = 39500;
#define k k_interD2pyrDDANE_STFD
 double k = 0.01;
 ...
 "Beta1_interD2pyrDDANE_STFD", "/ms",
 "Beta2_interD2pyrDDANE_STFD", "/ms",
 "Betan1_interD2pyrDDANE_STFD", "/ms",
 "Betan2_interD2pyrDDANE_STFD", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_gaba", "ms",
 "AlphaTmax_gaba", "/ms",
 ...
 "k_interD2pyrDDANE_STFD", &k_interD2pyrDDANE_STFD,
 "GAPstart1_interD2pyrDDANE_STFD", &GAPstart1_interD2pyrDDANE_STFD,
 "GAPstop1_interD2pyrDDANE_STFD", &GAPstop1_interD2pyrDDANE_STFD,
 "DAstart1_interD2pyrDDANE_STFD", &DAstart1_interD2pyrDDANE_STFD,
 "DAstop1_interD2pyrDDANE_STFD", &DAstop1_interD2pyrDDANE_STFD,
 "DAstart2_interD2pyrDDANE_STFD", &DAstart2_interD2pyrDDANE_STFD,
 "DAstop2_interD2pyrDDANE_STFD", &DAstop2_interD2pyrDDANE_STFD,
 "DA_t1_interD2pyrDDANE_STFD", &DA_t1_interD2pyrDDANE_STFD,
 "DA_t2_interD2pyrDDANE_STFD", &DA_t2_interD2pyrDDANE_STFD,
 "DA_S_interD2pyrDDANE_STFD", &DA_S_interD2pyrDDANE_STFD,
 "Beta1_interD2pyrDDANE_STFD", &Beta1_interD2pyrDDANE_STFD,
 "Beta2_interD2pyrDDANE_STFD", &Beta2_interD2pyrDDANE_STFD,
 "NEstart1_interD2pyrDDANE_STFD", &NEstart1_interD2pyrDDANE_STFD,
 "NEstop1_interD2pyrDDANE_STFD", &NEstop1_interD2pyrDDANE_STFD,
 "NEstart2_interD2pyrDDANE_STFD", &NEstart2_interD2pyrDDANE_STFD,
 "NEstop2_interD2pyrDDANE_STFD", &NEstop2_interD2pyrDDANE_STFD,
 "NE_t1_interD2pyrDDANE_STFD", &NE_t1_interD2pyrDDANE_STFD,
 "NE_t2_interD2pyrDDANE_STFD", &NE_t2_interD2pyrDDANE_STFD,
 "NE_S_interD2pyrDDANE_STFD", &NE_S_interD2pyrDDANE_STFD,
 "Betan1_interD2pyrDDANE_STFD", &Betan1_interD2pyrDDANE_STFD,
 "Betan2_interD2pyrDDANE_STFD", &Betan2_interD2pyrDDANE_STFD,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _interD2pyrDDANE_STFD_reg() {
	int _vectorized = 0;
  _initlists();
 	ion_reg("ca", -10000.);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 interD2pyrDDANE_STFD /home/nest/Desktop/Project_codes/KimEtAl2013/x86_64/interD2pyrDDANE_STFD.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 157 in file interD2pyrDDANE_STFD.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nest/Desktop/Project_codes/KimEtAl2013/mods/interD2pyrDDANE_STFD.mod";
static const char* nmodl_file_text = 
  ":Interneuron Cells to Pyramidal Cells GABA with local Ca2+ pool and read public soma Ca2+ pool\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS interD2pyrDDANE_STFD\n"
  ...
  "	NE_t2 = 1 :1 : 0.8\n"
  "	NE_S = 1 : 0.4\n"
  "	Betan1 = 0.001  (/ms) : 1/decay time for neuromodulators\n"
  "	Betan2 = 0.0001  (/ms)		\n"
  "}\n"
  "\n"
  "ASSIGNED {\n"
