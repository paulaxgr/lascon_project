...
#define nrn_init _nrn_init__interD2pyrDDA_STFD
#define _nrn_initial _nrn_initial__interD2pyrDDA_STFD
#define nrn_cur _nrn_cur__interD2pyrDDA_STFD
#define _nrn_current _nrn_current__interD2pyrDDA_STFD
#define nrn_jacob _nrn_jacob__interD2pyrDDA_STFD
#define nrn_state _nrn_state__interD2pyrDDA_STFD
#define _net_receive _net_receive__interD2pyrDDA_STFD 
#define release release__interD2pyrDDA_STFD 
...
#define DA2 DA2_interD2pyrDDA_STFD
#define DA1 DA1_interD2pyrDDA_STFD
#define GAP1 GAP1_interD2pyrDDA_STFD
#define eta eta_interD2pyrDDA_STFD
#define omega omega_interD2pyrDDA_STFD
#define unirand unirand_interD2pyrDDA_STFD
...
#define Beta2 Beta2_interD2pyrDDA_STFD
 double Beta2 = 0.0001;
#define Beta1 Beta1_interD2pyrDDA_STFD
 double Beta1 = 0.001;
#define DA_S DA_S_interD2pyrDDA_STFD
 double DA_S = 1.6;
#define DA_t2 DA_t2_interD2pyrDDA_STFD
 double DA_t2 = 1.5;
#define DA_t1 DA_t1_interD2pyrDDA_STFD
 double DA_t1 = 0.7;
#define DAstop2 DAstop2_interD2pyrDDA_STFD
 double DAstop2 = 36000;
#define DAstart2 DAstart2_interD2pyrDDA_STFD
 double DAstart2 = 35900;
#define DAstop1 DAstop1_interD2pyrDDA_STFD
 double DAstop1 = 40000;
#define DAstart1 DAstart1_interD2pyrDDA_STFD
 double DAstart1 = 39500;
#define GAPstop1 GAPstop1_interD2pyrDDA_STFD
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_interD2pyrDDA_STFD
 double GAPstart1 = 96000;
#define k k_interD2pyrDDA_STFD
 double k = 0.01;
 ...
 "Beta1_interD2pyrDDA_STFD", "/ms",
 "Beta2_interD2pyrDDA_STFD", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_gaba", "ms",
 "AlphaTmax_gaba", "/ms",
 ...
 "k_interD2pyrDDA_STFD", &k_interD2pyrDDA_STFD,
 "GAPstart1_interD2pyrDDA_STFD", &GAPstart1_interD2pyrDDA_STFD,
 "GAPstop1_interD2pyrDDA_STFD", &GAPstop1_interD2pyrDDA_STFD,
 "DAstart1_interD2pyrDDA_STFD", &DAstart1_interD2pyrDDA_STFD,
 "DAstop1_interD2pyrDDA_STFD", &DAstop1_interD2pyrDDA_STFD,
 "DAstart2_interD2pyrDDA_STFD", &DAstart2_interD2pyrDDA_STFD,
 "DAstop2_interD2pyrDDA_STFD", &DAstop2_interD2pyrDDA_STFD,
 "DA_t1_interD2pyrDDA_STFD", &DA_t1_interD2pyrDDA_STFD,
 "DA_t2_interD2pyrDDA_STFD", &DA_t2_interD2pyrDDA_STFD,
 "DA_S_interD2pyrDDA_STFD", &DA_S_interD2pyrDDA_STFD,
 "Beta1_interD2pyrDDA_STFD", &Beta1_interD2pyrDDA_STFD,
 "Beta2_interD2pyrDDA_STFD", &Beta2_interD2pyrDDA_STFD,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 interD2pyrDDA_STFD /home/nest/Desktop/Project_codes/KimEtAl2013/x86_64/interD2pyrDDA_STFD.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 146 in file interD2pyrDDA_STFD.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nest/Desktop/Project_codes/KimEtAl2013/mods/interD2pyrDDA_STFD.mod";
static const char* nmodl_file_text = 
  ":Interneuron Cells to Pyramidal Cells GABA with local Ca2+ pool and read public soma Ca2+ pool\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS interD2pyrDDA_STFD\n"
