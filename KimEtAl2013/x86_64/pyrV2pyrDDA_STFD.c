...
#define nrn_init _nrn_init__pyrV2pyrDDA_STFD
#define _nrn_initial _nrn_initial__pyrV2pyrDDA_STFD
#define nrn_cur _nrn_cur__pyrV2pyrDDA_STFD
#define _nrn_current _nrn_current__pyrV2pyrDDA_STFD
#define nrn_jacob _nrn_jacob__pyrV2pyrDDA_STFD
#define nrn_state _nrn_state__pyrV2pyrDDA_STFD
#define _net_receive _net_receive__pyrV2pyrDDA_STFD 
#define release release__pyrV2pyrDDA_STFD 
...
#define DA2 DA2_pyrV2pyrDDA_STFD
#define DA1 DA1_pyrV2pyrDDA_STFD
#define eta eta_pyrV2pyrDDA_STFD
#define omega omega_pyrV2pyrDDA_STFD
#define sfunc sfunc_pyrV2pyrDDA_STFD
#define unirand unirand_pyrV2pyrDDA_STFD
...
#define Beta2 Beta2_pyrV2pyrDDA_STFD
 double Beta2 = 0.0001;
#define Beta1 Beta1_pyrV2pyrDDA_STFD
 double Beta1 = 0.001;
#define DA_S DA_S_pyrV2pyrDDA_STFD
 double DA_S = 1.3;
#define DA_t2 DA_t2_pyrV2pyrDDA_STFD
 double DA_t2 = 0.8;
#define DA_t1 DA_t1_pyrV2pyrDDA_STFD
 double DA_t1 = 1.2;
#define DAstop2 DAstop2_pyrV2pyrDDA_STFD
 double DAstop2 = 36000;
#define DAstart2 DAstart2_pyrV2pyrDDA_STFD
 double DAstart2 = 35900;
#define DAstop1 DAstop1_pyrV2pyrDDA_STFD
 double DAstop1 = 40000;
#define DAstart1 DAstart1_pyrV2pyrDDA_STFD
 ...
 "Beta1_pyrV2pyrDDA_STFD", "/ms",
 "Beta2_pyrV2pyrDDA_STFD", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_nmda", "ms",
 "AlphaTmax_nmda", "/ms",
 ...
 "DAstart1_pyrV2pyrDDA_STFD", &DAstart1_pyrV2pyrDDA_STFD,
 "DAstop1_pyrV2pyrDDA_STFD", &DAstop1_pyrV2pyrDDA_STFD,
 "DAstart2_pyrV2pyrDDA_STFD", &DAstart2_pyrV2pyrDDA_STFD,
 "DAstop2_pyrV2pyrDDA_STFD", &DAstop2_pyrV2pyrDDA_STFD,
 "DA_t1_pyrV2pyrDDA_STFD", &DA_t1_pyrV2pyrDDA_STFD,
 "DA_t2_pyrV2pyrDDA_STFD", &DA_t2_pyrV2pyrDDA_STFD,
 "DA_S_pyrV2pyrDDA_STFD", &DA_S_pyrV2pyrDDA_STFD,
 "Beta1_pyrV2pyrDDA_STFD", &Beta1_pyrV2pyrDDA_STFD,
 "Beta2_pyrV2pyrDDA_STFD", &Beta2_pyrV2pyrDDA_STFD,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyrV2pyrDDA_STFD /home/nest/Desktop/Project_codes/KimEtAl2013/x86_64/pyrV2pyrDDA_STFD.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 152 in file pyrV2pyrDDA_STFD.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nest/Desktop/Project_codes/KimEtAl2013/mods/pyrV2pyrDDA_STFD.mod";
static const char* nmodl_file_text = 
