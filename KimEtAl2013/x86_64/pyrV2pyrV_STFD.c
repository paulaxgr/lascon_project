...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyrV2pyrV_STFD /home/nest/Desktop/Project_codes/KimEtAl2013/x86_64/pyrV2pyrV_STFD.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 145 in file pyrV2pyrV_STFD.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nest/Desktop/Project_codes/KimEtAl2013/mods/pyrV2pyrV_STFD.mod";
static const char* nmodl_file_text = 
  ":Pyramidal Cells to Pyramidal Cells AMPA+NMDA with local Ca2+ pool\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS pyrV2pyrV_STFD\n"
  "	USEION ca READ eca	\n"
  ...
  "\n"
  "	initW = 1 :  0.9 : 0.7 : 0.5 : 1: 4 : 4 : 10 : 5 : 4 :1.5\n"
  "	fmax = 4 : 4 : 3 : 5 : 3\n"
  "	fmin = .8\n"
  "	\n"
  "	GAPstart1 = 96000\n"
