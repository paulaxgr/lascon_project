...
#define nrn_init _nrn_init__pyrV2pyrD_STFD
#define _nrn_initial _nrn_initial__pyrV2pyrD_STFD
#define nrn_cur _nrn_cur__pyrV2pyrD_STFD
#define _nrn_current _nrn_current__pyrV2pyrD_STFD
#define nrn_jacob _nrn_jacob__pyrV2pyrD_STFD
#define nrn_state _nrn_state__pyrV2pyrD_STFD
#define _net_receive _net_receive__pyrV2pyrD_STFD 
#define release release__pyrV2pyrD_STFD 
...
#define eta eta_pyrV2pyrD_STFD
#define omega omega_pyrV2pyrD_STFD
#define sfunc sfunc_pyrV2pyrD_STFD
#define unirand unirand_pyrV2pyrD_STFD
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyrV2pyrD_STFD /home/nest/Desktop/Project_codes/KimEtAl2013/x86_64/pyrV2pyrD_STFD.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 141 in file pyrV2pyrD_STFD.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nest/Desktop/Project_codes/KimEtAl2013/mods/pyrV2pyrD_STFD.mod";
static const char* nmodl_file_text = 
  ":Pyramidal Cells to Pyramidal Cells AMPA+NMDA with local Ca2+ pool\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS pyrV2pyrD_STFD\n"
  "	USEION ca READ eca	\n"
