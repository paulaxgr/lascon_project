...
#define nrn_init _nrn_init__interV2pyrDDA_STFD
#define _nrn_initial _nrn_initial__interV2pyrDDA_STFD
#define nrn_cur _nrn_cur__interV2pyrDDA_STFD
#define _nrn_current _nrn_current__interV2pyrDDA_STFD
#define nrn_jacob _nrn_jacob__interV2pyrDDA_STFD
#define nrn_state _nrn_state__interV2pyrDDA_STFD
#define _net_receive _net_receive__interV2pyrDDA_STFD 
#define release release__interV2pyrDDA_STFD 
...
#define DA2 DA2_interV2pyrDDA_STFD
#define DA1 DA1_interV2pyrDDA_STFD
#define GAP1 GAP1_interV2pyrDDA_STFD
#define eta eta_interV2pyrDDA_STFD
#define omega omega_interV2pyrDDA_STFD
#define unirand unirand_interV2pyrDDA_STFD
...
#define Beta2 Beta2_interV2pyrDDA_STFD
 double Beta2 = 0.0001;
#define Beta1 Beta1_interV2pyrDDA_STFD
 double Beta1 = 0.001;
#define DA_S DA_S_interV2pyrDDA_STFD
 double DA_S = 1.6;
#define DA_t2 DA_t2_interV2pyrDDA_STFD
 double DA_t2 = 1.5;
#define DA_t1 DA_t1_interV2pyrDDA_STFD
 double DA_t1 = 0.7;
#define DAstop2 DAstop2_interV2pyrDDA_STFD
 double DAstop2 = 36000;
#define DAstart2 DAstart2_interV2pyrDDA_STFD
 double DAstart2 = 35900;
#define DAstop1 DAstop1_interV2pyrDDA_STFD
 double DAstop1 = 40000;
#define DAstart1 DAstart1_interV2pyrDDA_STFD
 double DAstart1 = 39500;
#define GAPstop1 GAPstop1_interV2pyrDDA_STFD
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_interV2pyrDDA_STFD
 double GAPstart1 = 96000;
#define k k_interV2pyrDDA_STFD
 double k = 0.01;
 ...
 "Beta1_interV2pyrDDA_STFD", "/ms",
 "Beta2_interV2pyrDDA_STFD", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_gaba", "ms",
 "AlphaTmax_gaba", "/ms",
 ...
 "k_interV2pyrDDA_STFD", &k_interV2pyrDDA_STFD,
 "GAPstart1_interV2pyrDDA_STFD", &GAPstart1_interV2pyrDDA_STFD,
 "GAPstop1_interV2pyrDDA_STFD", &GAPstop1_interV2pyrDDA_STFD,
 "DAstart1_interV2pyrDDA_STFD", &DAstart1_interV2pyrDDA_STFD,
 "DAstop1_interV2pyrDDA_STFD", &DAstop1_interV2pyrDDA_STFD,
 "DAstart2_interV2pyrDDA_STFD", &DAstart2_interV2pyrDDA_STFD,
 "DAstop2_interV2pyrDDA_STFD", &DAstop2_interV2pyrDDA_STFD,
 "DA_t1_interV2pyrDDA_STFD", &DA_t1_interV2pyrDDA_STFD,
 "DA_t2_interV2pyrDDA_STFD", &DA_t2_interV2pyrDDA_STFD,
 "DA_S_interV2pyrDDA_STFD", &DA_S_interV2pyrDDA_STFD,
 "Beta1_interV2pyrDDA_STFD", &Beta1_interV2pyrDDA_STFD,
 "Beta2_interV2pyrDDA_STFD", &Beta2_interV2pyrDDA_STFD,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 interV2pyrDDA_STFD /home/nest/Desktop/Project_codes/KimEtAl2013/x86_64/interV2pyrDDA_STFD.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 146 in file interV2pyrDDA_STFD.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nest/Desktop/Project_codes/KimEtAl2013/mods/interV2pyrDDA_STFD.mod";
static const char* nmodl_file_text = 
  ":Interneuron Cells to Pyramidal Cells GABA with local Ca2+ pool and read public soma Ca2+ pool\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS interV2pyrDDA_STFD\n"
