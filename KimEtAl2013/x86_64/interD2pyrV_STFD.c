...
#define nrn_init _nrn_init__interD2pyrV_STFD
#define _nrn_initial _nrn_initial__interD2pyrV_STFD
#define nrn_cur _nrn_cur__interD2pyrV_STFD
#define _nrn_current _nrn_current__interD2pyrV_STFD
#define nrn_jacob _nrn_jacob__interD2pyrV_STFD
#define nrn_state _nrn_state__interD2pyrV_STFD
#define _net_receive _net_receive__interD2pyrV_STFD 
#define release release__interD2pyrV_STFD 
...
#define GAP1 GAP1_interD2pyrV_STFD
#define eta eta_interD2pyrV_STFD
#define omega omega_interD2pyrV_STFD
#define unirand unirand_interD2pyrV_STFD
...
#define GAPstop1 GAPstop1_interD2pyrV_STFD
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_interD2pyrV_STFD
 double GAPstart1 = 96000;
#define k k_interD2pyrV_STFD
 double k = 0.01;
 ...
 "k_interD2pyrV_STFD", &k_interD2pyrV_STFD,
 "GAPstart1_interD2pyrV_STFD", &GAPstart1_interD2pyrV_STFD,
 "GAPstop1_interD2pyrV_STFD", &GAPstop1_interD2pyrV_STFD,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 interD2pyrV_STFD /home/nest/Desktop/Project_codes/KimEtAl2013/x86_64/interD2pyrV_STFD.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 137 in file interD2pyrV_STFD.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nest/Desktop/Project_codes/KimEtAl2013/mods/interD2pyrV_STFD.mod";
static const char* nmodl_file_text = 
  ":Interneuron Cells to Pyramidal Cells GABA with local Ca2+ pool and read public soma Ca2+ pool\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS interD2pyrV_STFD\n"
