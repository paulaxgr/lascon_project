...
#define nrn_init _nrn_init__tone2pyrDNE_LAdv
#define _nrn_initial _nrn_initial__tone2pyrDNE_LAdv
#define nrn_cur _nrn_cur__tone2pyrDNE_LAdv
#define _nrn_current _nrn_current__tone2pyrDNE_LAdv
#define nrn_jacob _nrn_jacob__tone2pyrDNE_LAdv
#define nrn_state _nrn_state__tone2pyrDNE_LAdv
#define _net_receive _net_receive__tone2pyrDNE_LAdv 
#define release release__tone2pyrDNE_LAdv 
...
#define NE2 NE2_tone2pyrDNE_LAdv
#define NEn NEn_tone2pyrDNE_LAdv
#define eta eta_tone2pyrDNE_LAdv
#define omega omega_tone2pyrDNE_LAdv
#define sfunc sfunc_tone2pyrDNE_LAdv
...
#define Beta2 Beta2_tone2pyrDNE_LAdv
 double Beta2 = 0.0001;
#define Beta1 Beta1_tone2pyrDNE_LAdv
 double Beta1 = 0.001;
#define NE_S NE_S_tone2pyrDNE_LAdv
 double NE_S = 1.3;
#define NE_t2 NE_t2_tone2pyrDNE_LAdv
 double NE_t2 = 0.9;
#define NE_t1 NE_t1_tone2pyrDNE_LAdv
 double NE_t1 = 1;
#define NEstop2 NEstop2_tone2pyrDNE_LAdv
 double NEstop2 = 36000;
#define NEstart2 NEstart2_tone2pyrDNE_LAdv
 double NEstart2 = 35900;
#define NEstop1 NEstop1_tone2pyrDNE_LAdv
 double NEstop1 = 40000;
#define NEstart1 NEstart1_tone2pyrDNE_LAdv
 ...
 "Beta1_tone2pyrDNE_LAdv", "/ms",
 "Beta2_tone2pyrDNE_LAdv", "/ms",
 "Cdur_nmda", "ms",
 "AlphaTmax_nmda", "/ms",
 "Beta_nmda", "/ms",
 "Erev_nmda", "mV",
 ...
 "NEstart1_tone2pyrDNE_LAdv", &NEstart1_tone2pyrDNE_LAdv,
 "NEstop1_tone2pyrDNE_LAdv", &NEstop1_tone2pyrDNE_LAdv,
 "NEstart2_tone2pyrDNE_LAdv", &NEstart2_tone2pyrDNE_LAdv,
 "NEstop2_tone2pyrDNE_LAdv", &NEstop2_tone2pyrDNE_LAdv,
 "NE_t1_tone2pyrDNE_LAdv", &NE_t1_tone2pyrDNE_LAdv,
 "NE_t2_tone2pyrDNE_LAdv", &NE_t2_tone2pyrDNE_LAdv,
 "NE_S_tone2pyrDNE_LAdv", &NE_S_tone2pyrDNE_LAdv,
 "Beta1_tone2pyrDNE_LAdv", &Beta1_tone2pyrDNE_LAdv,
 "Beta2_tone2pyrDNE_LAdv", &Beta2_tone2pyrDNE_LAdv,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 tone2pyrDNE_LAdv /home/nest/Desktop/Project_codes/KimEtAl2013/x86_64/tone2pyrDNE_LAdv.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nest/Desktop/Project_codes/KimEtAl2013/mods/tone2pyrDNE_LAdv.mod";
static const char* nmodl_file_text = 
  ":Tone to Pyramidal Cells AMPA+NMDA with local Ca2+ pool\n"
  " \n"
  "NEURON {\n"
  "	POINT_PROCESS tone2pyrDNE_LAdv\n"
  "	USEION ca READ eca	\n"
  ...
  "	Beta2 = 0.0001  (/ms)	\n"
  "	\n"
  "	initW = 5.5 : 6.5 : 5 : 4 : 3 : 4 : 8\n"
  "\n"
  "	lambda1 = 6 : 10 : 15 : 20 : 30: 20 : 15\n"
  "	lambda2 = .04 : .0 : 0.03\n"
